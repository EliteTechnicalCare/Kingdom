...
public class Settings {
	...
	public static final String SERVER_NAME = "Project Side";
	public static void welcome(Client c) {
		BufferedReader welcome = null;
		 
		try {
 			String sCurrentLine;
 			welcome = new BufferedReader(new FileReader("./Data/cfg/Welcome.STN"));
 			while ((sCurrentLine = welcome.readLine()) != null) {
				c.sendMessage(sCurrentLine);
			}
	...
	public static final int START_LOCATION_X = 3350;
	public static final int START_LOCATION_Y = 3001;
